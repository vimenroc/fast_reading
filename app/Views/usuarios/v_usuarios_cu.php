...
<?= $this->section('scripts') ?>
    ...
    <script>
        ...
        <?php if ($capítulo){ ?>
            let libro = <?= $libro ?>;
            let capítulo = <?= $capítulo ?>;
            let método = "U";
            let backURL = "<?= base_url('libro/')?>"+libro;
        <?php }else{
            echo "let libro =  $libro; let capítulo = null; let método = 'C'; let backURL = '".base_url('libros')."'";
        } ?>
        ...
        $( document ).ready(function() {
            ...
            $('#capítulo-detalles').submit(function (e) {
                ...
                console.log(capítuloData);
                Guardar(url, capítuloData, $("#guardar"));
